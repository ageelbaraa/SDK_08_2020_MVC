...
namespace WebApplication4.Controllers
{
    public class StudentTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SID,SName,SBirthDate,SUserName,SPassword,SGPA")] StudentTable studentTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SID,SName,SBirthDate,SUserName,SPassword,SGPA")] StudentTable studentTable)
        {
            if (ModelState.IsValid)
            {
